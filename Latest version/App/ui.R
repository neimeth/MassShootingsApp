...
forum.link    <- 'http://www.guncontrolforums.com/discussion/316/gun-control-should-we-ban-them'
                   ...
                   tabPanel('Interactive Map',
                            div(class='outer', 
                                ...
                                absolutePanel(id = "controls", class = "panel panel-default", fixed = TRUE,
                                              ...
                                              width = "200", height = "auto", h3("Shootings Plotter"),
                                              selectInput("year", "Select Time Frame", vars),
                                              radioButtons("shot", "Circle Size Reflects", vars2, selected = "Wounded"),
                                              helpText((a('Data: Shootingtracker.com',
                                                            href = 'http://shootingtracker.com/wiki/Mass_Shootings_in_2015',
                                                            target = '_blank')),
                                                       ('2015 data is through December 2, 2015'),
                                                       ('==============='),
                                                       (a('Click HERE to join the discussion',
                                                          href = 'http://www.guncontrolforums.com/discussion/316/gun-control-should-we-ban-them',
                                                          target = '_blank'))
                                                       )
                                )### End of tab panel
                            ) ### End of div
